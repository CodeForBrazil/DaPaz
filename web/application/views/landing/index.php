...
<html>
  <head>
    ...
    <!-- MAIN STYLE -->
    <link href="assets/landing/css/customize.css" rel="stylesheet" media="screen">
    <link href="assets/landing/style.css" rel="stylesheet" media="screen">
    <!-- FONTS -->
  ...
  <body>
		...
		<div id="main-container">
			...
			<div class="sticky-wrapper">
				<nav id="navigation">
					<div class="container">
						<!-- LOGO GOES HERE -->
						<a href="#" id="logo"><img src="assets/landing/images/logo.png" alt="Logo Image"></a>
						<!-- MENU -->
						<nav>
							<ul id="menu">
								<li><a href="#project">Projeto</a></li>
								<li><a href="map">CuritibaDaPaz</a></li>
			...
			<section id="project" class="section" >
	            ...
	            <ul class="sequence-canvas">
	            	...
	            	<li style="background-color: #82b440;">
		            	<div class="slide-content">
			            	<h1>Nosso projeto</h1>
			            	<h3>Através de pontos em um mapa, você pode facilmente localizar instituições que ajudam refugiados e moradores de ruas. Nós funcionamos como uma ponte, que liga você até essas instituições. <a href="map">Ir para o mapa!</a> </h3>
			                 	</div>
	            	</li>
	             </ul>
	...
	<script src="assets/landing/js/alert.js"></script>
	<script src="assets/landing/js/jquery.sequence-min.js"></script>
    <script src="assets/landing/js/jquery.fancybox.pack.js"></script>
    <script src="assets/landing/js/jquery.scrollUp.min.js"></script>
    <script src="assets/landing/js/jquery.smoothscroll.min.js"></script>
    <script src="assets/landing/js/jquery.meanmenu.min.js"></script>
    <script src="assets/landing/js/pace.min.js"></script>
    <script src="assets/landing/js/jquery.flexslider-min.js"></script>
